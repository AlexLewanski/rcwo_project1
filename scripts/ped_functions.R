...
#
# ped A pedigree dataframe in the format output by the process_ped function.
# id The id of the individual(s) whose completeness you want calculated. The option 'all' can be used if you want the completeness of all individuals to be calculated.
# max_gen For each individual, the maximum number of generations for which to calculate completeness. The option 'all' will result in completeness being calculated for all generations present in the generation for each individual.
# A dataframe containing completeness information for individuals in the pedigree.
#
#
...
#
# ped A pedigree dataframe in the format output by the process_ped function.
# gen The number of generations to consider for the compl_index calculation
# summary The measures used to summarize the pedigree
#
# A dataframe with the completeness and/or depth measures of the pedigree
